...
export const DOMAIN_SCHEMA = {
  ...
  appTitle: "Apex Pharma Logistics",
  ...
  problemStatement: "Manual temperature logging and disconnected supplier manifests cause compliance audit failures and an 18% spoilage rate of sensitive biopharma shipments across multi-hop transit routes.\n1. Real-time IoT temperature telemetry ingestion with automated threshold alerts.\n2. Sub-second compliance audit reporting for FDA and ISO certifications.\n3. Cut transit inventory spoilage to under 1.5%.",
  columns: {
...
const STORAGE_KEY = 'bizzmitra-apex-pharma-logistics-healthcare_db_healthcare_v1';
const USERS_STORAGE_KEY = 'bizzmitra-apex-pharma-logistics-healthcare_users_healthcare_v1';
const SPRINTS_STORAGE_KEY = 'bizzmitra-apex-pharma-logistics-healthcare_sprints_healthcare_v1';
const ACTIVE_SESSION_KEY = 'bizzmitra-apex-pharma-logistics-healthcare_session_healthcare_v1';
